...
class CartButton{
	...
	showEnterVR( button ) {
        ...
        button.onclick=function(){
            if(currentSession==null){
                const sessionInt={optionalFeatures:['local-floor','bounded-floor']};
                navigator.xr.requestSession('immersive-vr',sessionInt).then(onSessionStarted);
            }else{
                currentSession.end();
            }
        }
    ...
    showWebXRNotFound( button ) { 
        ...
        button.textContent='VR No supported :(';
    }
